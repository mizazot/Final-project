...
(A) .Rmd Line numbers where at least two different data sources are imported: 24 - 36


(B) .Rmd Line numbers for inspecting data intake: 43-46
...
(A) .Rmd Line number(s) for general data wrangling: 50 - 174, 230-233, 256-259, 274-275, 282-286, 295-297, 


(B) .Rmd Line number(s) for a join operation: 180 - 224, 294


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): 293


(D) .Rmd Line number(s) for use of regular expressions: 


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 259, 261


(F) .Rmd Line number(s) for use of user-defined functions: 50-67
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  244, 304

(B) .Rmd Line number(s) for use of multiple aesthetics:  242, 245, 246, 303-306, 

(C) .Rmd Line number(s) for use of layered graphics:  243-244
